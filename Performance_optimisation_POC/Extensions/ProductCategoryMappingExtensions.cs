...
public static class ProductCategoryMappingExtensions
{
    ...
    public static void UpdateFromRequest(this Data.Domain.Entities.ProductCategory category, ProductCategoryUpdateRequest request)
    {
    ...
    public static List<ProductCategoryResponse> ToResponseList(this IEnumerable<Data.Domain.Entities.ProductCategory> categories)
    {
        return categories.Select(c => c.ToResponse()).ToList();
    }

    // Convert collection of entities to list item DTOs
    public static List<ProductCategoryListItem> ToListItems(this IEnumerable<Data.Domain.Entities.ProductCategory> categories)
    {
