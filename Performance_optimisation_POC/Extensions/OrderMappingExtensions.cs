...
public static class OrderMappingExtensions
{
    ...
    public static OrderListItem ToListItem(this Order order)
    {
    ...
    public static Order ToEntity(this OrderCreateRequest request)
    {
        var order = new Order
        {
        ...
        {
            order.OrderItems.Add(itemDto.ToEntity(order.OrderId));
        }
    ...
    public static void UpdateFromRequest(this Order order, OrderUpdateRequest request)
    {
        order.Status = request.Status;
    }

    // Convert collection of entities to response DTOs
    public static List<OrderResponse> ToResponseList(this IEnumerable<Order> orders)
    {
        return orders.Select(o => o.ToResponse()).ToList();
    }

    // Convert collection of entities to list item DTOs
    public static List<OrderListItem> ToListItems(this IEnumerable<Order> orders)
    {
